...
class Serial_COM{
  public:
    ...
    String makeInstruction(String, String, String, String[], int, char*);
    String makeInstruction(String, String, String, int[], int, char*);
    void sendInstruction(String, String, String, int[], int);
    void sendInstruction(String, String, String, String[], int);
    void start();
...
String Serial_COM::makeInstruction(String src_id, String dest_id, String instr_id, String data[], int data_size, char *delimiter=" "){
  String instruction = src_id+delimiter+dest_id+delimiter+instr_id;
...
// Sends the instruction via Serial; delay is to ensure instruction is completely sent.
void Serial_COM::sendInstruction(String src_id, String dest_id, String instr_id, String data[], int data_size){ 
  String instruction = makeInstruction(src_id, dest_id, instr_id, data, data_size, " ");
  Serial.println(instruction); 
  delay(INSTR_DELAY); 
}
